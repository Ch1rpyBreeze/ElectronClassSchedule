...
const _scheduleConfig = {
    ...
    daily_class: [
        ...
        },
        {
            Chinese: '一',
            English: 'MON',
            classList: ['数', '英', '语', '史', '班', '地', '美', ['语', '语'], ['数', '数']],
            timetable: 'workday'
        },
        {
            Chinese: '二',
            English: 'TUE',
            classList: ['化', '英', '生@物', '数', '信', '语', '体', ['语', '语'], ['数', '数']],
            timetable: 'workday'
        },
        {
            Chinese: '三',
            English: 'WED',
            classList: ['语', '数', '音', '化', '物', '政', '生@物', ['校', '史'], ['化', '政']],
            timetable: 'workday'
        },
        {
            Chinese: '四',
            English: 'THR',
            classList: ['语', '生@物', '体', '英', '史', '信', '物', ['物', '地'], ['英', '英']],
            timetable: 'workday'
        },
        {
            Chinese: '五',
            English: 'FRI',
            classList: ['物', '地', '化', '政', '数', '英', '生@涯', '自', '自', ['生@物', '史'], ['英', '英']],
            timetable: 'workday'
        },
        {
            Chinese: '六',
